...
- [semantic-search-tier](architecture/semantic-search-tier.md) — semantic recall is an opt-in `[semantic]` extra fused into RRF; core stays zero-dep, degrades to BM25. Sources: raw/sources/2026-06-17-agent-memory-landscape.md.
- [semi-automatic-capture](architecture/semi-automatic-capture.md) — `draft` mode stages candidates in the cache; human approves via `/capture --review`. Sources: raw/sources/2026-06-17-agent-memory-landscape.md.
