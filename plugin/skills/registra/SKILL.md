---
name: registra
description: Capture the current conversation into durable, git-versioned memory (source / concept / contract / proposal / persona) with a human write-gate. Use when the user says "/registra", "capture this", "save to the brain", "remember this decision", or accepts a proactive capture offer.
---

# registra — capture chat into durable knowledge
