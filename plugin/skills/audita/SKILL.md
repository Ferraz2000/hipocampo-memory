---
name: audita
description: Fact-check a vault page against its cited sources — every claim must trace to a source that actually supports it. Use when the user says "/audita <path>", "fact-check this note", "verify this page against its sources".
---

# audita — fact-check a page against its sources
