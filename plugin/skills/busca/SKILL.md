---
name: busca
description: Keyword-search the vault (knowledge/insights/specs/raw sources) by relevance, BM25 with an optional FTS5 fast path. Use when the user says "/busca", "search the brain/vault", "find notes about X".
---

# busca — search the vault
