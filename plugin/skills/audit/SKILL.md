---
name: audit
description: Fact-check a vault page against its cited sources — every claim must trace to a source that actually supports it. Use when the user says "/audit <path>", or the pt-BR alias "/audita", "fact-check this note", "verify this page against its sources".
---
